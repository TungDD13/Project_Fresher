...
{
    public class BookInitializer: DropCreateDatabaseIfModelChanges<BookStoreContext>
    {
        protected override void Seed(BookStoreContext context)
        {
            //Category cate1 = new Category() { CategoryName = "Anime", CreateDate = new DateTime(2019, 01, 01), ModifieDate = new DateTime(2019, 02, 02), Description = "this is a Description 1" };
            //Category cate2 = new Category() { CategoryName = "Viet Nam", CreateDate = new DateTime(2019, 01, 01), ModifieDate = new DateTime(2019, 02, 02), Description = "this is a Description 2" };
            //Category cate3 = new Category() { CategoryName = "Dan Gian", CreateDate = new DateTime(2019, 01, 01), ModifieDate = new DateTime(2019, 02, 02), Description = "this is a Description 3" };
            //context.Categories.AddOrUpdate(c => c.CategoryName, cate1, cate2, cate3);

            //Publisher pub1 = new Publisher() { PublisherName = "Doan Tung", Description = "he is a publisher" };
            //Publisher pub2 = new Publisher() { PublisherName = "Doan Tung 2", Description = "he is a publisher 2" };
            //context.Publishers.AddOrUpdate(p => p.PublisherName, pub1, pub2);

            //Author author1 = new Author() { AuthorName = "Doan Tung", Description = "Description1" };
            //Author author2 = new Author() { AuthorName = "Doan Tung 2", Description = "Description1 2" };
            //context.Authors.AddOrUpdate(a => a.AuthorName, author1, author2);
            //context.SaveChanges();
            ...
            //    ModifiedDate = new DateTime(2019, 02, 02),
            //    IsActive = true,
            //};
        ...
        static private void AddData(BookStoreContext context)
        {
            ...
            {
                item.CreateDate = new DateTime(2019, 01, 01);
                item.ModifieDate = new DateTime(2019, 01, 01);
            }
            ...
            var books = new List<Book>
            {
                new Book()
                {
                    ...
                    Price = 169000M,
                    CreatedDate = new DateTime(2019, 01, 01),
                    ModifiedDate = new DateTime(2019, 01, 01),
                    IsActive = false,
                    Quantity = 52,
