...
namespace FA.BookStore.Core.Models
{
    class BookInitializer: DropCreateDatabaseAlways<BookContext>
    {
        ...
        {
            Category cate1 = new Category() { CateName = "Anime", Description = "this is a Description 1" };
            Category cate2 = new Category() { CateName = "Viet Nam", Description = "this is a Description 2" };
            Category cate3 = new Category() { CateName = "Dan Gian", Description = "this is a Description 3" };
